...
import co.bangumi.common.model.BangumiDetail
import co.bangumi.common.model.Episode
import co.bangumi.common.view.ScrollStartLayoutManager
...
class DetailActivity : co.bangumi.common.activity.BaseActivity() {
    val iv by lazy { findViewById(co.bangumi.Cygnus.R.id.image) as ImageView? }
    //    val ivCover by lazy { findViewById(R.id.image_cover) as ImageView }
//    val ctitle by lazy { findViewById(R.id.title) as TextView }
    val subtitle by lazy { findViewById(co.bangumi.Cygnus.R.id.subtitle) as TextView }
    val info by lazy { findViewById(co.bangumi.Cygnus.R.id.info) as TextView }
    val summary by lazy { findViewById(co.bangumi.Cygnus.R.id.summary) as TextView }
    val summary2 by lazy { findViewById(co.bangumi.Cygnus.R.id.summary2) as TextView }
    val more by lazy { findViewById(co.bangumi.Cygnus.R.id.button_more) as TextView }
    val spinner by lazy { findViewById(co.bangumi.Cygnus.R.id.spinner) as Spinner }
    val recyclerView by lazy { findViewById(co.bangumi.Cygnus.R.id.recycler_view) as RecyclerView }
    val summaryLayout by lazy { findViewById(co.bangumi.Cygnus.R.id.summary_layout) }
    val btnBgmTv by lazy { findViewById(co.bangumi.Cygnus.R.id.button_bgm_tv) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(co.bangumi.Cygnus.R.layout.activity_detail)
        ...
        setData(bgm!!)
        loadData(bgm.id)
        title = co.bangumi.common.StringUtil.mainTitle(bgm)
    }
    ...
    private fun openMenu(episode: co.bangumi.common.model.Episode) {
        val dialog = BottomSheetDialog(this, co.bangumi.Cygnus.R.style.BottomSheetDialog)
        val view = LayoutInflater.from(this).inflate(co.bangumi.Cygnus.R.layout.dialog_episode_menu, null, false)
        ...
        (view.findViewById(co.bangumi.Cygnus.R.id.title) as TextView).text =
                "${episode.episode_no}. $name"

        view.findViewById(co.bangumi.Cygnus.R.id.button_mark_watched).setOnClickListener {
            markWatched(episode)
            dialog.dismiss()
        }
...
//            dialog.dismiss()
//        }
        view.findViewById(co.bangumi.Cygnus.R.id.button_open_external).setOnClickListener {
            openWith(episode)
            dialog.dismiss()
        }
...
//        ctitle.text = StringUtil.mainTitle(detail)
        ...
        info.text = resources.getString(co.bangumi.Cygnus.R.string.update_info)
        ...
        if (TextUtils.isEmpty(detail.summary)) {
            ...
            fun less() {
                ...
                more.setText(co.bangumi.Cygnus.R.string.more)
                more.tag = 1
            }
            ...
            fun more() {
                ...
                summary2.text = ""
                summary.maxLines = 20
                more.setText(co.bangumi.Cygnus.R.string.less)
                more.tag = 0
            }
        ...
        val adapter = ArrayAdapter.createFromResource(this,
                co.bangumi.Cygnus.R.array.array_favorite, co.bangumi.Cygnus.R.layout.spinner_item)
    ...
    inner class EpisodeAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        inner class VH(v: View) : RecyclerView.ViewHolder(v) {
            val view = v
            val tv = v.findViewById(co.bangumi.Cygnus.R.id.tv) as TextView
            val image = v.findViewById(co.bangumi.Cygnus.R.id.image) as ImageView
            val progress = v.findViewById(co.bangumi.Cygnus.R.id.progress) as co.bangumi.common.view.ProgressCoverView
        }
        ...
        override fun onCreateViewHolder(p0: ViewGroup?, p1: Int): RecyclerView.ViewHolder {
            return VH(LayoutInflater.from(p0!!.context).inflate(co.bangumi.Cygnus.R.layout.rv_item_episode, p0, false))
        }
