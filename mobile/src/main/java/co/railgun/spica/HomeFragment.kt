...
import co.railgun.spica.homefragment.HomeData
import co.railgun.spica.homefragment.HomeHorizontalAdapter
import co.railgun.spica.homefragment.HomeLargeAdapter
import co.railgun.common.api.ListResponse
...
class HomeFragment : co.railgun.common.activity.BaseFragment() {
    ...
    private fun loadData() {
        ...
        Observable.zip(
                withLifecycle(co.railgun.common.api.ApiClient.getInstance().getAnnounceBangumi()),
                withLifecycle(co.railgun.common.api.ApiClient.getInstance().getMyBangumi(1, -1, Bangumi.Status.WATCHING.value)),
                withLifecycle(co.railgun.common.api.ApiClient.getInstance().getOnAir(Bangumi.Type.ALL.value)),
