package co.bangumi.common.player
...
class CygnusExoPlayer : FrameLayout {
    ...
    fun setControllerView(views: ControllerViews?) {
        ...
        views.progressbar?.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            ...
            override fun onStartTrackingTouch(seekBar: SeekBar) {
                tracking = true
                position?.text = co.bangumi.common.StringUtil.microsecondFormat(player.currentPosition)
            }
    ...
    private val checkProgress = {
        if (!tracking && player.duration > 0) {
            ...
            this.duration?.text = co.bangumi.common.StringUtil.microsecondFormat(player.duration)
            this.position?.text = co.bangumi.common.StringUtil.microsecondFormat(player.currentPosition)
        }
    ...
    data class ControllerViews(val root: View,
                               val play: co.bangumi.common.view.CheckableImageButton?,
                               val screen: co.bangumi.common.view.CheckableImageButton?,
