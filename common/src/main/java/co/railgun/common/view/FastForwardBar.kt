package co.railgun.common.view
...
class FastForwardBar(context: Context?,
    ...
    init {
        ...
        paint.alpha = 0xE2
        paint.textSize = co.railgun.common.DisplayUtil.dp2px(resources, 24).toFloat()
//        paint.setShadowLayer(10.0f, 0.0f, 2.0f, 0xA0000000.toInt())
    }

    private fun isValid(): Boolean {
        return Math.abs(startPosition.first - endPosition.first) > co.railgun.common.DisplayUtil.dp2px(resources, 4)
    }
    ...
    private fun calcRange(distance: Float): Int {
        return co.railgun.common.DisplayUtil.px2dp(resources, distance) / 6
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawRect(
                ...
                startPosition.second - co.railgun.common.DisplayUtil.dp2px(resources, 2),
        ...
        canvas.drawText(
                toRangeDisplay(),
                (startPosition.first + endPosition.first) / 2 - co.railgun.common.DisplayUtil.dp2px(resources, 8),
                startPosition.second - co.railgun.common.DisplayUtil.dp2px(resources, 6),
                paint)
    }
